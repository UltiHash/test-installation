...
echo " "
echo ""
echo -e "${BOLD_TEAL}➡️  WRITE THROUGHPUT: ${WRITE_SPEED} MB/s"
echo -e "${BOLD_TEAL}⬅️  READ THROUGHPUT:  ${READ_SPEED} MB/s"
echo ""
echo -e "${BOLD_TEAL}📦 ORIGINAL SIZE: ${ORIG_GB} GB"
echo -e "${BOLD_TEAL}✨ DEDUPLICATED SIZE: ${EFF_GB} GB"
echo -e "${BOLD_TEAL}✅ SAVED WITH ULTIHASH: ${SAV_GB} GB (${PCT}%)"
echo ""
