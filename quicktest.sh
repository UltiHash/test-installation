...
echo ""
echo "🌛 The UltiHash cluster has been shut down, and the data you stored in it has been wiped. In measuring read speed, a copy of your data was placed in ${RAW_PATH}-retrieved. Make sure to go check it out, and then delete it when you're done."
echo ""
