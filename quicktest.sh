...
echo "In measuring read speed, a copy of your data was placed in ${RAW_PATH}-retrieved."
echo "Make sure to go check it out, and then delete it when you're done."
echo ""
